...
public class Serie implements Comparable<Serie>{
	...
	public void annadirTemporada( String nombreTemporada) throws SerieException {
		Temporada buscar = new Temporada(nombreTemporada);
		if(temporadas.contains(buscar)) {
			throw new SerieException("Esa temporada ya existe");
		}
			this.temporadas.add(buscar);
	...
	public String listadoTemporadasPorNumeroDeCapitulos() {
		StringBuilder sb = new StringBuilder();
		Collections.sort(this.temporadas, new TemporadasNumCapitulosComparator());
		for(Temporada t: temporadas) {
			sb.append(t+"\n");
		}
		return sb.toString();
	...
	public void temporadaToCsv() {
		File exportado = new File("files/Temporada.csv");
		try {
			...
			for(Temporada t:this.temporadas) {
				bw.append(String.format("%s,%s,%s,%s,%s", this.nombreSerie, t.getNombreTemporada(), t.getNumCapitulos(), t.getSumaOpiniones(), t.getNumeroOpiniones()));
				bw.newLine();
			}
			bw.close();
			fw.close();
	...
	public boolean equals(Object obj) {
		return obj instanceof Serie && this.hashCode()==obj.hashCode();
	}
